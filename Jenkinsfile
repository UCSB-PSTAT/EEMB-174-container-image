            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        ...
                        sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"tidyverse\");library(\"rethinking\");library(\"bayesplot\");library(\"brms\");library(\"rstanarm\");library(\"tidybayes\");library(\"tidybayes\");library(\"shinystan\");library(\"cmdstanr\")"'
