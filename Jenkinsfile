                ...
                stage('Test') {
                    steps {
                        container('podman') {
                            ...
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"bayesplot\")"'
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"brms\")"'
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"rethinking\")"'
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"rstanarm\")"'
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"shinystan\")"'
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"tidybayes\")"'
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"tidyverse\")"'
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"cmdstanr\");cmdstan_version()"'
